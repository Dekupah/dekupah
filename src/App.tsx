    ...
    <>
      ...
      <main className="max-w-5xl m-auto flex flex-col gap-3">
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-3xl font-bold uppercase" style={{color: "#F27C38"}}>Quem nós somos?</h2>
          ...
          <section className="flex flex-col gap-3">
            <section>
              <h2 className="text-3xl font-bold uppercase" style={{color: "#F27C38"}}>Nossos Projetos</h2>
            </section>
            <section>
              {/*--------------------------------------------------------------*/}
              <Article
